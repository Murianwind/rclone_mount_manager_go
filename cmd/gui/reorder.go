...
// 원본과 마운트 경계를 넘어서는 이동은 없다.
func (rm *rcloneManager) moveSelectedUp() { rm.moveSelected(swapRemotesUp, swapMountsUp) }

func (rm *rcloneManager) moveSelectedDown() { rm.moveSelected(swapRemotesDown, swapMountsDown) }
